...
void CScene2D::Rotate()
{
	...
	//回転の計算
	m_rotatePos[0].x = (posOrigin[0].x * cosf(m_fAngle)) - (posOrigin[0].y * sinf(m_fAngle));
	m_rotatePos[1].x = (posOrigin[1].x * cosf(m_fAngle)) - (posOrigin[1].y * sinf(m_fAngle));
	m_rotatePos[2].x = (posOrigin[2].x * cosf(m_fAngle)) - (posOrigin[2].y * sinf(m_fAngle));
	m_rotatePos[3].x = (posOrigin[3].x * cosf(m_fAngle)) - (posOrigin[3].y * sinf(m_fAngle));

	m_rotatePos[0].y = (posOrigin[0].x * sinf(m_fAngle)) + (posOrigin[0].y * cosf(m_fAngle));
	m_rotatePos[1].y = (posOrigin[1].x * sinf(m_fAngle)) + (posOrigin[1].y * cosf(m_fAngle));
	m_rotatePos[2].y = (posOrigin[2].x * sinf(m_fAngle)) + (posOrigin[2].y * cosf(m_fAngle));
	m_rotatePos[3].y = (posOrigin[3].x * sinf(m_fAngle)) + (posOrigin[3].y * cosf(m_fAngle));
	...
	//バッファの生成
	pVtx[0].pos = D3DXVECTOR3(m_pos.x + m_rotatePos[0].x, m_pos.y + m_rotatePos[0].y, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(m_pos.x + m_rotatePos[1].x, m_pos.y + m_rotatePos[1].y, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(m_pos.x + m_rotatePos[2].x, m_pos.y + m_rotatePos[2].y, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(m_pos.x + m_rotatePos[3].x, m_pos.y + m_rotatePos[3].y, 0.0f);
...
void CScene2D::Rotate(D3DXVECTOR3 pos, D3DXVECTOR3 scale)
{
	...
	//バッファの生成
	pVtx[0].pos = D3DXVECTOR3(pos.x + m_rotatePos[0].x, pos.y + m_rotatePos[0].y, 0.0f);
	pVtx[1].pos = D3DXVECTOR3(pos.x + m_rotatePos[1].x, pos.y + m_rotatePos[1].y, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(pos.x + m_rotatePos[2].x, pos.y + m_rotatePos[2].y, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(pos.x + m_rotatePos[3].x, pos.y + m_rotatePos[3].y, 0.0f);

	m_pVtxBuff->Unlock();

	//エフェクト出現位置
	SetEffect(D3DXVECTOR3(pVtx[0].pos.x + 20, pVtx[0].pos.y + 10, {}));
